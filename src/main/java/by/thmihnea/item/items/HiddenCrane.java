...
public class HiddenCrane extends AzaleaItem {
    public HiddenCrane(Material material, String name, String type, int id, Rarity rarity, int health, int defense, int attackDamage, int critDamage, int critChance, int mana, int manaCost, Ability ability, boolean placeable, boolean stackable) {
    ...
    private void init(Player player) {
        ...
        if (itemizedPlayer.hasCooldown(CooldownType.SNEAK)) {
            itemizedPlayer.getCooldownByType(CooldownType.SNEAK).sendCooldownMessage();
            return;
        }
        Cooldown cooldown = new Cooldown(player, CooldownType.SNEAK, 45);
